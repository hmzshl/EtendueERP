...
namespace EtendueERP.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<EtendueERP.Models.ApplicationUser> users;
        protected RadzenDataGrid<EtendueERP.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(EtendueERP.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(EtendueERP.Models.ApplicationUser user)
        {
            try
            {
