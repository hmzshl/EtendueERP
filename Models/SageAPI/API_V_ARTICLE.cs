...
namespace EtendueERP.Models.SageAPI
{
    public partial class API_V_ARTICLE
    {
        ...
        public decimal? DL_Qte_Vente { get; set; }
        public decimal? DL_MontantHT_Vente { get; set; }
        public decimal? DL_MontantTTC_Vente { get; set; }
        public decimal? DL_Qte_Achat { get; set; }
        public decimal? DL_MontantHT_Achat { get; set; }
        public decimal? DL_MontantTTC_Achat { get; set; }
        public string CL_Intitule { get; set; }
        public string CL_Num { get; set; }
        public DateTime? DL_DateBL_Vente { get; set; }
        public decimal? DL_Dernier_MontantHT_Vente { get; set; }
        public decimal? DL_Dernier_MontantTTC_Vente { get; set; }
        public decimal? DL_PU_Vente { get; set; }
        public decimal? DL_Dernier_Qte_Vente { get; set; }
        public string FR_Intitule { get; set; }
        public string FR_Num { get; set; }
        public DateTime? DL_DateBL_Achat { get; set; }
        public decimal? DL_Dernier_MontantHT_Achat { get; set; }
        public decimal? DL_Dernier_MontantTTC_Achat { get; set; }
        public decimal? DL_PU_Achat { get; set; }
        public decimal? DL_Dernier_Qte_Achat { get; set; }
